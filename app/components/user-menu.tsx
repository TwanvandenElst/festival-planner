      ...
      {open && (
        ...
        >
          ...
          <button
            ...
            className="mt-1 flex w-full items-center justify-center gap-1.5 rounded-lg py-1.5 text-sm font-medium text-muted-foreground/70 transition-colors hover:text-foreground"
          >
